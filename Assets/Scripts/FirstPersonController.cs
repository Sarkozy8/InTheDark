    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (GameObject.Find("Mission Light Halo") && !haloBool)
            {
                ...
                this.transform.position = playerPositionNew;
        ...
        private void Move()
        {
            ...
            _animator.SetBool("Running", _input.sprint);
            _animator.SetBool("Walking", _input.move != Vector2.zero ? true : false);
            ...
            {
                targetSpeed = 0.0f;
                _globalReferences.playerMoving = false;
            }
            else
            {
                _globalReferences.playerMoving = true;
            }
